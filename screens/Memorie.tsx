    ...
    useEffect(() => {
        const loadHighScore = async () => {
            try {
                ...
                console.error("Erreur lors du chargement du meilleur score", e);
            }
        };
        loadHighScore();
    }, []);
        ...
        const timer = setInterval(() => {
            setTime((prevTime) => {
                if (prevTime <= 1) {
                    ...
                    if (score > highScore) {
                        setHighScore(score);
                        AsyncStorage.setItem('highScore', score.toString()).catch(e =>
                            console.error("Erreur lors de l'enregistrement du meilleur score", e)
                        );
                    }
                    return 0;
                }
